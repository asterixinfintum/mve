...
var register = (0, _express["default"])();
register.post('/checkduplicateuser', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, email, phonenumber;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, email = _req$body.email, phonenumber = _req$body.phonenumber;
          _user["default"].checkforduplicates(email, phonenumber).then(function (success) {
            res.status(200).send({
              success: success
            });
...
register.post('/signup', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body2, firstname, lastname, email, phonenumber, password;
