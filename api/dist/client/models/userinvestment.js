...
userInvestmentSchema.statics.getuserinvestments = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(user) {
    var UserInvestmnt, userinvestments, investmentsarr, _iterator, _step, userinvestment, investmentitem;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          UserInvestmnt = this;
          _context.next = 4;
          return UserInvestmnt.find({
            user: user
          });
        case 4:
          userinvestments = _context.sent;
          investmentsarr = [];
          _iterator = _createForOfIteratorHelper(userinvestments);
          _context.prev = 7;
          _iterator.s();
        case 9:
          ...
          userinvestment = _step.value;
          _context.next = 13;
          return _investmentplan["default"].findOne({
            _id: userinvestment.investmentid
          });
        case 13:
          investmentitem = _context.sent;
          if (investmentitem) {
            investmentsarr.push({
