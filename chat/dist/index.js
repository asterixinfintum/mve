...
var _chatmsg = _interopRequireDefault(require("./routes/chatmsg"));
...
var allowedOrigins = ["".concat(process.env.baseurl), "".concat(process.env.wwwbaseurl)];
var corsOptions = {
...
function _initSocketIO() {
  _initSocketIO = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          io.on('connection', /*#__PURE__*/function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(socket) {
              var userid, user;
              return _regeneratorRuntime().wrap(function _callee6$(_context6) {
                while (1) switch (_context6.prev = _context6.next) {
                  case 0:
                    ...
                    _context6.next = 3;
                    return (0, _utils.setUserState)(userid);
                  case 3:
                    user = _context6.sent;
                    if (user) {
                      socket.user = user;
                    ...
                    socket.on('sendMessage', /*#__PURE__*/function () {
                      var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(data) {
                        var savedChatMessage;
                        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                          while (1) switch (_context3.prev = _context3.next) {
                            case 0:
                              _context3.prev = 0;
                              _context3.next = 3;
                              return (0, _utils.createMsg)(data, socket.user._id);
                            case 3:
                              savedChatMessage = _context3.sent;
                              if (savedChatMessage) {
                                io.emit('newMessage', {
                            ...
                            case 7:
                              ...
                              console.error('Error saving message:', _context3.t0);
                            case 10:
                            case "end":
                    ...
                    socket.on('setMsgAsSeen', /*#__PURE__*/function () {
                        ...
                        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                          while (1) switch (_context4.prev = _context4.next) {
                            case 0:
                              _context4.prev = 0;
                              _context4.next = 3;
                              return (0, _utils.setMsgAsSeen)(data);
                            case 3:
                            ...
                            case 6:
                              ...
                              console.error('Error saving message:', _context4.t0);
                            case 9:
                            case "end":
